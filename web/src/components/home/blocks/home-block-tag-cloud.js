...
const HomeBlockTagCloud = ({ data }) => {
  ...
  return (
    <div className={styles.marqueeWrapper} style={bgColor}>
      ...
      >
        <div
          className={`${styles.marqueeItems__slide} ${styles.marqueeItems__slide_left} ${styles.hoverBlue}`}
        >
          {wordList.map(item => (
            <Link to="/our-podcasts" key={item}>
              <span>{item}</span>
            </Link>
          ))}
        </div>
      ...
      >
        <div
          className={`${styles.marqueeItems__slide} ${styles.marqueeItems__slide_right} ${styles.hoverTurq}`}
        >
          {wordList.map(item => (
            <Link to="/our-podcasts" key={item}>
              <span>{item}</span>
      ...
      >
        <div
          className={`${styles.marqueeItems__slide} ${styles.marqueeItems__slide_left_slower} ${styles.hoverDarkBlue}`}
        >
          {wordList.map(item => (
            <Link to="/our-podcasts" key={item}>
              <span>{item}</span>
      ...
      >
        <div
          className={`${styles.marqueeItems__slide} ${styles.marqueeItems__slide_right_slower} ${styles.hoverGrey}`}
        >
          {wordList.map(item => (
            <Link to="/our-podcasts" key={item}>
              <span>{item}</span>
...
export default HomeBlockTagCloud;
